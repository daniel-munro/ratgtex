...
function renderBubbleMap(par, gene, tissues, exons, tissueSiteTable, urls, update=false){
    ...
    $(`#${par.divInfo}`).text('Total significant associations: ' + par.data.length)
...
function addBubbleClickEvent(bmap, bmapSvg, par) {
    ...
    bmapSvg.selectAll('.bubble-map-cell')
        .on("click", (d) => {
            ...
            eqtlViolinPlotRender(vConfig, d.geneId, d.variantId, d.tissueSiteDetailId, d.displayY, bmap.urls)
