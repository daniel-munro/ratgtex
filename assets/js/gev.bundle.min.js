var GeneEqtlVisualizer = (function (exports) {
   ...
   * @returns {*}
   */
  function createSvg$1(id, width, height, margin, svgId=undefined, position="relative"){
      checkDomId(id);
  ...
  function render(par, geneId, urls = getGtexUrls()){
      $(`#${par.divSpinner}`).show();
  ...
  function addBubbleClickEvent(bmap, bmapSvg, par) {
      ...
      bmapSvg.selectAll('.bubble-map-cell')
          .on("click", (d) => {
              ...
              render$1(vConfig, d.geneId, d.variantId, d.tissueSiteDetailId, d.displayY, bmap.urls);
