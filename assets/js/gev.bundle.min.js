var GeneEqtlVisualizer = (function (exports) {
  ...
  const kernel = {
      gaussian: function(u){return 1/Math.sqrt(2*Math.PI)*Math.exp(-0.5*u*u)}
  };
      ...
      zoom(dom, theBrush){
          ...
          this.groups.forEach((gg, i)=> {
              ...
              entries.forEach((entry) => {
                  ...
                  g.select(".violin-ir")
                      .transition(t)
                      .attr("x", this.scale.z(-0.1))
                      .attr("y", this.scale.y(q3))
                      .attr("width", Math.abs(this.scale.z(-0.1) - this.scale.z(z)))
